...
- Contradicts the design goal: value semantics are correct for Metel even if the PoC doesn't fully achieve them yet (see RFC-0006).
...
- #292 — Iterable<T> aspect and for-in upgrade
