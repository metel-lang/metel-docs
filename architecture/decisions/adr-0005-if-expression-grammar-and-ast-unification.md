...
This is surprising for users and inconsistent with Rust, whose design Metel borrows
...
**Cons:**
- Surprising to users; diverges from the Rust design Metel follows
...
- Spec: [Declarations](../../reference/spec/declarations.md), [Expressions](../../reference/spec/expressions.md)
