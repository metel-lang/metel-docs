...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::merge_from`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L4043) |
| `verified by` | [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::block_local_type_id_is_disjoint_from_name_resolver_ids`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L5613); [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::merge_from_does_not_collapse_same_named_structs`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L5578); [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::same_named_structs_in_two_modules_keep_distinct_field_sets`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L5547) |
| `last_reviewed` | 22f1104b6b7e8cc50978fd429537ecfd4267c336 |
...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/inference.rs::infer_propagate_error`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/inference.rs#L1556) |
| `verified by` | [`metel-frontend/src/pipeline/type_checking/mod.rs::from_impl_lookup_runs_in_inference_not_construction`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/mod.rs#L1547); [`metel-interpreter/tests/integration/sources/typechecking/error_handling/stage6_neg_06_error_propagation_mismatched_types.toml`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/integration/sources/typechecking/error_handling/stage6_neg_06_error_propagation_mismatched_types.toml#L1) |
...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/construction.rs::construct_program`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/construction.rs#L1216) |
| `verified by` | [`metel-frontend/src/pipeline/type_checking/mod.rs::construction_never_runs_the_constraint_solver`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/mod.rs#L1558); [`metel-interpreter/tests/integration/sources/typechecking/functions/stage7_01_return_type_propagation.toml`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/integration/sources/typechecking/functions/stage7_01_return_type_propagation.toml#L1) |
| `last_reviewed` | de72649a95a5c947ac985069b692008b76a82f7e |
...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/inference/declarations.rs::infer_decl`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/inference/declarations.rs#L19) |
...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::unify`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L870) |
| `verified by` | [`metel-interpreter/tests/unit/typeinference_tests.rs::test_occurs_check_array`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/unit/typeinference_tests.rs#L485); [`metel-interpreter/tests/unit/typeinference_tests.rs::test_occurs_check_function`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/unit/typeinference_tests.rs#L494) |
| `last_reviewed` | 22f1104b6b7e8cc50978fd429537ecfd4267c336 |
| `related` | `metel-frontend/docs/typechecker.md` |
...
| `owner` | `metel-frontend` |
| `specified by` | `#type-inference` |
| `implements` | [`metel-frontend/src/pipeline/type_checking/typeinference/mod.rs::generalize`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-frontend/src/pipeline/type_checking/typeinference/mod.rs#L1736) |
| `verified by` | [`metel-interpreter/tests/unit/typeinference_tests.rs::test_generalize_env_blocks_capture`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/unit/typeinference_tests.rs#L691); [`metel-interpreter/tests/unit/typeinference_tests.rs::test_generalize_partial_capture`](https://github.com/metel-lang/metel-core/blob/482a47de2a50db592c02804b14155c2310a76bb5/metel-interpreter/tests/unit/typeinference_tests.rs#L705) |
| `last_reviewed` | 22f1104b6b7e8cc50978fd429537ecfd4267c336 |
| `related` | `metel-frontend/docs/typechecker.md` |
