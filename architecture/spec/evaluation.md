...
| `implements` | [`metel-interpreter/src/evaluator/mod.rs::get_local`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L1735) |
| `verified by` | [`metel-interpreter/src/evaluator/mod.rs::a_binding_with_no_id_is_simply_not_stored`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4133); [`metel-interpreter/src/evaluator/mod.rs::define_binding_is_readable_by_local_id`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4124); [`metel-interpreter/src/evaluator/mod.rs::distinct_local_ids_do_not_alias`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4144); [`metel-interpreter/tests/integration/sources/module_semantics/top_level_bindings_are_isolated_per_module/test.toml`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/tests/integration/sources/module_semantics/top_level_bindings_are_isolated_per_module/test.toml#L1) |
...
| `owner` | `metel-interpreter` |
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/pattern.rs::match_pattern`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/pattern.rs#L24) |
| `verified by` | [`metel-interpreter/src/evaluator/mod.rs::perhaps_and_result_have_no_dedicated_value_variants`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4439); [`metel-interpreter/tests/integration/sources/evaluator/builtins/83_perhaps_result_methods.toml`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/tests/integration/sources/evaluator/builtins/83_perhaps_result_methods.toml#L1) |
...
| `owner` | `metel-interpreter` |
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/call.rs::bind_method_params`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/call.rs#L16) |
...
| `owner` | `metel-interpreter` |
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/mod.rs::define_binding`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L1694) |
| `verified by` | [`metel-interpreter/src/evaluator/mod.rs::define_binding_deep_clones_arrays`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4352); [`metel-interpreter/src/evaluator/mod.rs::set_local_deep_clones_arrays`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4367) |
| `last_reviewed` | c5619cae663b522b9c41aaa04f5a82788394dbbe |
| `related` | ADR-0007 |
...
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/call.rs::call_runtime_callable`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/call.rs#L55) |
...
| `owner` | `metel-interpreter`, `metel-frontend` |
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/type_of.rs::value_to_type`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/type_of.rs#L23) |
...
| `owner` | `metel-interpreter` |
| `specified by` | `#evaluation` |
| `implements` | [`metel-interpreter/src/evaluator/mod.rs::get_type_value_by_id`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L781) |
| `verified by` | [`metel-interpreter/src/evaluator/mod.rs::same_named_types_dispatch_by_symbol_id_not_name`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/src/evaluator/mod.rs#L4422); [`metel-interpreter/tests/integration/sources/evaluator/functions/toplevel_let_mut_bound_function_dispatch.toml`](https://github.com/metel-lang/metel-core/blob/26ffffc1aabe3e17d10726af0d719a8ab79a7869/metel-interpreter/tests/integration/sources/evaluator/functions/toplevel_let_mut_bound_function_dispatch.toml#L1) |
| `last_reviewed` | c5619cae663b522b9c41aaa04f5a82788394dbbe |
