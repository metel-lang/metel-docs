...
| `implements` | [`metel-frontend/src/symbols.rs::default`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/symbols.rs#L73) |
| `verified by` | [`metel-frontend/src/name_resolver.rs::same_declaration_gets_same_symbol_id_regardless_of_importer`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/name_resolver.rs#L1294) |
...
| `owner` | `metel-frontend` |
| `specified by` | `#name-resolution` |
| `implements` | [`metel-frontend/src/name_resolver.rs::canonical_path`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/name_resolver.rs#L100) |
| `verified by` | [`metel-frontend/src/name_resolver.rs::resolves_explicit_item_import`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/name_resolver.rs#L814) |
...
| `owner` | `metel-frontend` |
| `specified by` | `#name-resolution` |
| `implements` | [`metel-frontend/src/reference_resolver.rs::collect_references`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/reference_resolver.rs#L70) |
| `verified by` | [`metel-frontend/src/reference_resolver.rs::resolves_top_level_call_to_its_symbol_id`](https://github.com/metel-lang/metel-core/blob/c5619cae663b522b9c41aaa04f5a82788394dbbe/metel-frontend/src/reference_resolver.rs#L472) |
| `last_reviewed` | 2ae8fae97336bfe87d459103ad85d8fecbbab4ca |
