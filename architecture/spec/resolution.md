...
| `implements` | [`metel-frontend/src/identity.rs::as_global`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-frontend/src/identity.rs#L156) |
| `verified by` | [`metel-frontend/src/identity/tests.rs::reference_table_is_total_and_unknown_names_are_explicit`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-frontend/src/identity/tests.rs#L298) |
...
| `owner` | `metel-frontend` |
| `specified by` | `#resolution` |
| `implements` | [`metel-frontend/src/identity/member.rs::new`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-frontend/src/identity/member.rs#L59) |
| `verified by` | [`metel-frontend/src/identity/member.rs::struct_fields_get_distinct_ids_owned_by_the_struct`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-frontend/src/identity/member.rs#L260) |
| `last_reviewed` | 2ae8fae97336bfe87d459103ad85d8fecbbab4ca |
...
| `owner` | `metel-frontend` |
| `specified by` | `#resolution` |
| `implements` | [`metel-frontend/src/identity/position.rs::from_entries`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-frontend/src/identity/position.rs#L42) |
| `verified by` | [`metel-interpreter/tests/integration/sources/evaluator/type_aliases/06_value_path.toml`](https://github.com/metel-lang/metel-core/blob/8717cc6088e4dcf55f6f5580e60ad936d9bf69cf/metel-interpreter/tests/integration/sources/evaluator/type_aliases/06_value_path.toml#L1) |
| `last_reviewed` | 2ae8fae97336bfe87d459103ad85d8fecbbab4ca |
| `related` | ADR-0054 (2026-09-10 amendment) |
