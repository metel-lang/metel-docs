...
- `internal/rfcs/5-superseded/rfc-0090-structural-records.md` §3 step 1 — the source, which
...
- `internal/rfcs/0-draft/rfc-0089-linear-types.md`,
  `internal/rfcs/0-draft/rfc-0091-linear-records.md` — per-field multiplicity, deliberately
