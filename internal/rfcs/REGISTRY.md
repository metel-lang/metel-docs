...
**122 RFCs total.** 37 draft, 4 under review, 8 accepted, 4 integrated (53 live), 42 implemented, 13 superseded, 14 refused (69 settled).
...
- **RFC-0089** — Linear Types (`0-draft` ; internal/rfcs/0-draft/rfc-0089-linear-types.md ; date 2026-07-09 ; updated 2026-07-24)
- **RFC-0091** — Linear Records (`0-draft` ; internal/rfcs/0-draft/rfc-0091-linear-records.md ; date 2026-07-09 ; updated 2026-07-24)
...
- **RFC-0109** — Self-View Narrowing and Reference-Destructuring Patterns (`0-draft` ; internal/rfcs/0-draft/rfc-0109-self-view-narrowing-and-reference-destructuring-patterns.md ; date 2026-07-18 ; updated 2026-07-24)
...
- **RFC-0117** — Row Narrowing (`0-draft` ; internal/rfcs/0-draft/rfc-0117-row-narrowing.md ; date 2026-07-24)
- **RFC-0119** — Record Conversions (`0-draft` ; internal/rfcs/0-draft/rfc-0119-record-conversions.md ; date 2026-07-24)
...
- **RFC-0122** — Borrow Checking (`0-draft` ; internal/rfcs/0-draft/rfc-0122-borrow-checking.md ; date 2026-07-24)
...
- **RFC-0071** — Ownership and Move Semantics (`3-integrated` ; internal/rfcs/3-integrated/rfc-0071-ownership-and-move-semantics.md ; date 2026-06-28 ; updated 2026-07-24 ; impl not-started ; tracking https://codeberg.org/metel-lang/metel-core/issues/291)
- **RFC-0115** — Field Initializer Separator (`3-integrated` ; internal/rfcs/3-integrated/rfc-0115-field-initializer-separator.md ; date 2026-07-24 ; updated 2026-07-24 ; impl not-started ; tracking https://codeberg.org/metel-lang/metel-core/issues/287)
- **RFC-0116** — Anonymous Record Types (`3-integrated` ; internal/rfcs/3-integrated/rfc-0116-anonymous-record-types.md ; date 2026-07-24 ; updated 2026-07-24 ; impl not-started ; tracking https://codeberg.org/metel-lang/metel-core/issues/288)
- **RFC-0118** — Row Bounds (`3-integrated` ; internal/rfcs/3-integrated/rfc-0118-row-bounds.md ; date 2026-07-24 ; updated 2026-07-24 ; impl not-started ; tracking https://codeberg.org/metel-lang/metel-core/issues/289)
