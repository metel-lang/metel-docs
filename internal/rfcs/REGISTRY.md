...
**123 RFCs total.** 38 draft, 4 under review, 8 accepted, 1 integrated (51 live), 45 implemented, 13 superseded, 14 refused (72 settled).
...
- **RFC-0124** — Sequence Types: Fixed Arrays, Slices, and the Growable List (`0-draft` ; internal/rfcs/0-draft/rfc-0124-sequence-types-fixed-arrays-slices-and-the-growable-list.md ; date 2026-07-25)
