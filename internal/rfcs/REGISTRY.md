...
**120 RFCs total.** 38 draft, 4 under review, 9 accepted, 0 integrated (51 live), 42 implemented, 13 superseded, 14 refused (69 settled).
...
- **RFC-0116** — Anonymous Record Types (`0-draft` ; internal/rfcs/0-draft/rfc-0116-anonymous-record-types.md ; date 2026-07-24)
- **RFC-0117** — Row Narrowing (`0-draft` ; internal/rfcs/0-draft/rfc-0117-row-narrowing.md ; date 2026-07-24)
- **RFC-0118** — Row Bounds (`0-draft` ; internal/rfcs/0-draft/rfc-0118-row-bounds.md ; date 2026-07-24)
