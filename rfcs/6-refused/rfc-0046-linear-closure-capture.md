...
- RFC-0006: `docs/public/rfcs/4-implemented/rfc-0006-closure-capture-semantics.md` — §"Fit with Linear Types and the Compiler"
- RFC-0028: `docs/public/rfcs/6-refused/rfc-0028-memory-and-reference-model.md`
- RFC-0025: `docs/public/rfcs/6-refused/rfc-0025-region-allocation.md`
- RFC-0050: `docs/public/rfcs/0-draft/rfc-0050-closure-capture-lists.md`
