...
- RFC-0025: `docs/public/rfcs/6-refused/rfc-0025-region-allocation.md` — `RegionFree`, implicit allocation, named region lifetimes
- RFC-0028: `docs/public/rfcs/6-refused/rfc-0028-memory-and-reference-model.md` — `@T`, `*T`, pointer model
