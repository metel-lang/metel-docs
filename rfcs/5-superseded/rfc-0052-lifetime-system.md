...
- RFC-0028: `docs/public/rfcs/6-refused/rfc-0028-memory-and-reference-model.md` — linear types, `@T`, `*T`; §1.5 explicitly defers to this RFC for linear borrows
- RFC-0025: `docs/public/rfcs/6-refused/rfc-0025-region-allocation.md` — region lifetimes; `*'r T`; `Send` interim constraint
- RFC-0051: `docs/public/rfcs/6-refused/rfc-0051-regionfree-exit-constraint.md` — `RegionFree<'r>`; lands as part of step 4 above
- RFC-0047: `docs/public/rfcs/6-refused/rfc-0047-owning-pointer-completeness.md` — `*T` from `@T`; OQ-2 there resolves under this RFC
