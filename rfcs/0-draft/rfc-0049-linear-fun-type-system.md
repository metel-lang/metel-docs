...
- RFC-0046: `docs/public/rfcs/6-refused/rfc-0046-linear-closure-capture.md` — `linear fun` type, `[move x]` captures
- RFC-0028: `docs/public/rfcs/6-refused/rfc-0028-memory-and-reference-model.md` — `Drop` aspect, linearity checker, `drop` function
- RFC-0006: `docs/public/rfcs/4-implemented/rfc-0006-closure-capture-semantics.md` — non-linear closure model
