...
Define whether and how Metel programs can recover from panics — the runtime errors currently triggered by `.yolo()` on `nope`/`Err`, out-of-bounds access, and division by zero.
