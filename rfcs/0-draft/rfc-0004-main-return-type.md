...
Metel's `main()` function currently returns `()`. This was a deliberate design
...
program, consistent with Metel's principle of explicit error handling.
...
The question is whether the same trade-off applies to Metel, and if so, how to
