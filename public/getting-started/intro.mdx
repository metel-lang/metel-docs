...
2. Check the [current release notes](../release-notes/changelog.md) for what changed recently.
3. Review the [example programs](examples) for concrete programs you can try.
4. Review the [error catalog](../reference/error-codes.md) if you want the public failure modes at a glance.
