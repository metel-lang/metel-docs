...
`Int` and `Float` are still the default ergonomic numeric types, but Metel also provides exact-width types when size matters:

- signed integers: `i8`, `i16`, `i32`, `i64`
- unsigned integers: `u8`, `u16`, `u32`, `u64`
- floats: `f32`, `f64`

`Int` is an alias for `i64`. `Float` is an alias for `f64`.
...
- Metel v0.8.0 adds exact-width numeric types without removing `Int` and `Float`.
