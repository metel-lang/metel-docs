...
**RFC-0122 (Borrow Checking) reached `2-accepted` on 2026-08-01**, clearing its v0.12.0
bar before the tag cut.

**Needs a decision from the operator, not just the agent:** *(nothing outstanding —
RFC-0122's timing question was answered 2026-08-01, see §0's directives, and the RFC
reached `2-accepted` the same day.)*
...
| 2 | Ownership enforcement and the borrow checker | RFC-0071 **`3-integrated`**, `impl_status: in-progress`; RFC-0122 **`2-accepted` (2026-08-01)**, all five design questions resolved; its §9b blocker discharged by #291 | **v0.12.0: #290/#291 shipped + 19 hardening fixes; v0.13.0: #292/#293 + 6 more queued** |
...
problem. Both halves of this priority now have accepted specifications; neither borrow
rule is enforced by anything yet.
