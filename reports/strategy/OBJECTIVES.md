...
such reversion in the corpus; Trigger 14 fired.
...
| 2 | Ownership enforcement and the borrow checker | RFC-0071 **`3-integrated`**, `impl_status: in-progress`; RFC-0122 **`1-under-review`** — accepted and reverted 2026-08-01 on six gaps (§2b), three blocking; its §9b blocker *is* discharged by #291 | **v0.12.0: #290/#291 shipped + 19 hardening fixes; v0.13.0: #292/#293 + 6 more queued** |
